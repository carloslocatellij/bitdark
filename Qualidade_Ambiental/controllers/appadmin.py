...
if request.function == 'manage':
    ...
    redirect(URL('admin', 'inicio', 'index',
...
if menu:
    response.menu = [[T('design'), False, URL('admin', 'inicio', 'design',
...
def manage():
    ...
    kwargs.update(**smartgrid_args.get('inicio', {}))
                    ...
                    if hasattr(f, '__call__'):
                        try:
                            ...
                            if details['filename']: # Built in functions as delete_uploaded_files are not editable
                                details['url'] = URL(a='admin',c='inicio',f='edit', args=[request['application'], details['filename']],vars={'lineno':details['lineno']})
